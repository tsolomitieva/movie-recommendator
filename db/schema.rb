...
ActiveRecord::Schema[7.0].define(version: 20_230_105_160_036) do
  ...
  create_table 'categories_movies', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[movie_id category_id], name: 'index_categories_movies_on_movie_id_and_category_id', unique: true
  end
  ...
  create_table 'users_movies', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'status'
    t.index %w[user_id movie_id], name: 'index_users_movies_on_user_id_and_movie_id', unique: true
  end
